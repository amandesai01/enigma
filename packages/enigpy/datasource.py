...
config = {
    "ENIGMA_FILE_ACCESS_ENDPOINT_MAP": getenv("ENIGMA_FAEM"),
    "ENIGMA_FILE_ACCESS_ENDPOINT_REDUCE": getenv("ENIGMA_FAER"),
    "ENIGMA_FILE_ACCESS_ENDPOINT_SHUFFLE": getenv("ENIGMA_FAES")
}
